...
wsl.exe docker run --rm --gpus all -v "/mnt/c/svrtk-docker-gpu/recon":/home/recon %dockerImageName% /home/scripts/docker-recon-brain-auto.bash /home/recon/ 1 -1 > C:\svrtk-docker-gpu\recon\pride\logs\log_svrtk_docker_gpu.txt
ECHO DONE
